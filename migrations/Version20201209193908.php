 ...
 */
final class Version20201209193908 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subscription_plan CHANGE subscriptions_id subscription_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_EA664B639A1887DC ON subscription_plan (subscription_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_EA664B639A1887DC ON subscription_plan');
        $this->addSql('ALTER TABLE subscription_plan CHANGE subscription_id subscriptions_id INT DEFAULT NULL');
